...
def create_parser():
    ...
    # method parameters
    parser.add_argument('--method', default='RDesignPro', choices=['SeqRNN', 'SeqLSTM', 'StructMLP', 'StructGNN', 'GraphTrans', 'HCGNN', 'PiFold'])
    parser.add_argument('--config_file', '-c', default='default.py', type=str)

    # training parameters
    parser.add_argument('--epoch', default=3, type=int, help='end epoch')
    ...
    # TEST
    parser.add_argument('--weigth_clu_con', default=1.0, type=float)
    parser.add_argument('--weigth_sam_con', default=1.0, type=float)
    parser.add_argument('--ss_temp', default=1.0, type=float)
    
    parser.add_argument('--conf_case', default=0, type=int)
