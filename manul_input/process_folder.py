...
from sequence_design import eval_sequence, featurize_HC, find_bracket_pairs
from sequence_design import call_python2_script, process_single_pdb
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        directory_path = '/tancheng/zyj/RoseTTAFold2NA/aptamer_exp/RNA_only/extracted_structures'
    else:
